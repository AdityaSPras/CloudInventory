    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <?php if ($title == 'Halaman Utama') : ?>
                ...
                <!-- Data Master -->
                <?php if ($title == 'Kategori Barang' or $title == 'Satuan Barang' or $title == 'Supplier Barang' or $title == 'Barang') : ?>
                    <li class="nav-item active">
                    <?php else : ?>
                    <li class="nav-item">
                    <?php endif; ?>
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?= base_url('karyawan/kategori'); ?>"><b>Kategori Barang</b></a>
                            <a class="collapse-item" href="<?= base_url('karyawan/satuan'); ?>"><b>Satuan Barang</b></a>
                            <a class="collapse-item" href="<?= base_url('karyawan/supplier'); ?>"><b>Supplier Barang</b></a>
                            <a class="collapse-item" href="<?= base_url('karyawan/barang'); ?>"><b>Barang</b></a>
                        </div>
                    </div>
                    </li>
                    ...
                    <?php if ($title == 'Barang Masuk') : ?>
                        ...
                        <?php if ($title == 'Barang Keluar') : ?>
                            ...
                            <?php if ($title == 'Kritik & Saran') : ?>
                                ...
                                <li class="nav-item">
                                <?php endif; ?>
                                <a class="nav-link" href="<?= base_url('karyawan/kritik_saran'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?= base_url('karyawan/profil'); ?>">
