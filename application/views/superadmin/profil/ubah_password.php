...
<div class="container-fluid">
    ...
    <div class="warning-flash-super-admin" data-flashdata="<?= $this->session->flashdata('warning'); ?>"></div>
    <div class="error-flash-super-admin" data-flashdata="<?= $this->session->flashdata('error'); ?>"></div>
                ...
                <div class="card-body p-4">
                    <form action="<?= base_url('superadmin/ubah_password'); ?>" method="POST">
                        ...
                        <div class="form-group text-center">
                            <a href="<?= base_url('superadmin/profil'); ?>" class="btn btn-success btn-md btn-icon-split mb-2">
