                        ...
                        <div class="mt-sm-1 col-sm-8 offset-sm-0">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-right mt-4">
                                    ...
                                    <a href="<?= base_url('admin/ubah_perusahaan'); ?>" class="btn btn-warning btn-md btn-icon-split mb-2">
                                        <span class="icon text-white"><i class="fas fa-pen"></i></span>
                                        <span class="text text-white">Ubah Profil Perusahaan</span>
                                    </a>
                                </div>
                            </div>
                        </div>
