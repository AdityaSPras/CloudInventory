                        ...
                        <div class="mt-sm-1 col-sm-8 offset-sm-0">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center mt-4">
                                    <a class="btn btn-secondary btn-icon-split mb-2 btn-md" href="<?= base_url('admin/ubah_profil'); ?>">
                                        <span class="icon text-white"><i class="fas fa-user"></i></span>
                                        <span class="text text-white">Ubah Profil</span>
                                    </a>
                                    <a class="btn btn-warning btn-icon-split mb-2 btn-md" href="<?= base_url('admin/ubah_password'); ?>">
                                        <span class="icon text-white"><i class="fas fa-key"></i></span>
                                        <span class="text text-white">Ubah Password</span>
                                    </a>
                                    <a class="btn btn-info btn-icon-split mb-2 btn-md" href="<?= base_url('admin/perusahaan'); ?>">
