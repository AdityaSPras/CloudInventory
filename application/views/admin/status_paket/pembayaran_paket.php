                    ...
                    <?php else : ?>
                        <?php if (time() - $data->TanggalTransaksi < (60 * 60 * 24)) { ?>
                            <div class="col-sm-8 mb-4">
                                <form action="<?= base_url() ?>admin/proses_pembayaran_paket" name="formAdminBayarPaket" method="POST" enctype="multipart/form-data" onsubmit="return validasiAdminBayarPaket()">
