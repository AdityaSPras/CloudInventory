    ...
    <div class="col-lg-12 mb-4" id="container">
        ...
        <div class="card shadow mb-2">
            ...
            <div class="col-sm-12 mt-2">
                <a href="<?= base_url('admin/tambah_kategori'); ?>" class="btn btn-sm btn-primary btn-icon-split">
                        ...
                        <tbody>
                            ...
                            foreach ($daftar_kategori as $data) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url("admin/detail_kategori/" . encrypt_url($data->IdKategori) . "") ?>" class="btn btn-circle btn-info btn-sm mb-1">
                                            <i class="fas fa-info"></i>
                                        </a>
                                        <a href="#" data-toggle="modal" data-target="#ubahKategori<?= encrypt_url($data->IdKategori) ?>" class="btn btn-circle btn-warning btn-sm mb-1">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <a href="#" onclick="hapus_kategori('<?= encrypt_url($data->IdKategori) ?>')" id="hapus_kategori" class="btn btn-circle btn-danger btn-sm mb-1">
...
foreach ($daftar_kategori as $data) : $no++; ?>
    <div class="modal fade" id="ubahKategori<?= encrypt_url($data->IdKategori) ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="<?= base_url() ?>admin/ubah_kategori" name="formAdminUbahKategori" method="POST" onsubmit="return validasiAdminUbahKategori()">
