    ...
    <div class="col-lg-12 mb-4" id="container">
        ...
        <div class="card shadow mb-2">
            ...
            <div class="col-sm-12 mt-2">
                <a href="<?= base_url('admin/tambah_satuan'); ?>" class="btn btn-sm btn-primary btn-icon-split">
                        ...
                        <tbody>
                            ...
                            foreach ($daftar_satuan as $data) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url("admin/detail_satuan/" . encrypt_url($data->IdSatuan) . "") ?>" class="btn btn-circle btn-info btn-sm mb-1">
                                            <i class="fas fa-info"></i>
                                        </a>
                                        <a href="#" data-toggle="modal" data-target="#ubahSatuan<?= encrypt_url($data->IdSatuan) ?>" class="btn btn-circle btn-warning btn-sm mb-1">
                                            <i class="fas fa-pen"></i>
                                        </a>
                                        <a href="#" onclick="hapus_satuan('<?= encrypt_url($data->IdSatuan) ?>')" id="hapus_satuan" class="btn btn-circle btn-danger btn-sm mb-1">
...
foreach ($daftar_satuan as $data) : $no++; ?>
    <div class="modal fade" id="ubahSatuan<?= encrypt_url($data->IdSatuan) ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="<?= base_url() ?>admin/ubah_satuan" name="formAdminUbahSatuan" method="POST" onsubmit="return validasiAdminUbahSatuan()">
