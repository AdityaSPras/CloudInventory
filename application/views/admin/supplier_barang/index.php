    ...
    <div class="col-lg-12 mb-4" id="container">
        ...
        <div class="card shadow mb-2">
            ...
            <div class="col-sm-12 mt-2">
                <a href="<?= base_url('admin/tambah_supplier'); ?>" class="btn btn-sm btn-primary btn-icon-split">
                        ...
                        <tbody>
                            ...
                            foreach ($daftar_supplier as $data) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url("admin/detail_supplier/" . encrypt_url($data->IdSupplier) . "") ?>" class="btn btn-circle btn-info btn-sm mb-1">
                                        ...
                                        <a href="#" onclick="hapus_supplier('<?= encrypt_url($data->IdSupplier) ?>')" id="hapus_supplier" class="btn btn-circle btn-danger btn-sm mb-1">
...
foreach ($daftar_supplier as $data) : $no++; ?>
    <div class="modal fade" id="ubahSupplier<?= encrypt_url($data->IdSupplier) ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="<?= base_url() ?>admin/ubah_supplier" name="formAdminUbahSupplier" method="POST" onsubmit="return validasiAdminUbahSupplier()">
