    ...
    <div class="container-fluid">
        ...
        <div class="error-flash-karyawan" data-flashdata="<?= $this->session->flashdata('error'); ?>"></div>
            ...
            <?php else : ?>
                <?php foreach ($ubah_barang as $data) : ?>
                    <div class="col-sm-8 mb-4">
                        <form action="<?= base_url() ?>karyawan/proses_ubah_barang" name="formKaryawanUbahBarang" method="POST" enctype="multipart/form-data" onsubmit="return validasiKaryawanUbahBarang()">
        ...
        <div class="col-sm-12 text-center mt-2 mb-2">
            <a class="btn btn-success btn-md btn-icon-split mb-1" href="<?= base_url('karyawan/barang'); ?>">
